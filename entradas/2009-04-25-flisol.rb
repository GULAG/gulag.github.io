...
def publicacion(dir)
    ...
    p             = Publicacion.new
    p.directorio  = dir
    p.archivo     = '2009-04-25-flisol'
    p.nombre      = 'FLISOL 2009'
    p.nombre_menu = 'FLISOL 2009'
    p.fecha       = "2009-04-25 23:00"
...
El *FLISOL 2009* se efectuará el día *sábado 25 de abril* en las instalaciones de la *Universidad Autónoma de Coahuila (UAC)*.
