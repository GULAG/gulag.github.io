...
<center>
<img class="img-responsive" style="width:60%;height:auto;margin-right:12px;" src="2017-05-20-flisol/01-flisol.jpg" alt="guabyboy" width="65" height="50">
</center>
...
Siempre se aprende algo nuevo, en esta ocasión al instalar un GNU/Linux Lubuntu en un equipo VAIO de Sony, se tuvo que emplear la intrucción al aranque, por cuestiones de procesador, de 
 <pre><code>--forcepae</code></pre>.


Al final del evento, como es costumbre, se procedió a un pequeño convivio
<center>
<img class="img-responsive" style="width:60%;height:auto;margin-right:12px;" src="2017-05-20-flisol/05-flisol.jpg" alt="Final" width="65" height="50">
</center> 
