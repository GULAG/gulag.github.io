PSPP Software estadístico
===========

Fecha: 2017-04-27 10:00
Autor: guabyboy
Categorías: Entradas, Softwarelibre, Educación
...
Desde consola Opensuse $yast -i pspp o bien $zypper install pspp
...
aplicaciones-> Educación -> GNU PSPP. Para abrir desde consola la interfaz gráfica $psppire y para trabajar PSPP en consola $pspp
