...
def publicacion(dir)
    ...
    p             = Publicacion.new
    p.directorio  = dir
    p.archivo     = '2008-09-20-aniversario'
    p.nombre      = 'Segundo Aniversario del Gulag / Software Freedom Day'
    p.nombre_menu = 'Segundo Aniversario del Gulag'
    p.fecha       = "2008-09-27 22:00"
...
A las 11 de la mañana Mahomedali Pacheco impartió la conferencia titulada "MVC seguro, orgánico y hasta excitante con ZendFramework".
De 12 a 12:30 se realizó un receso donde se pudo disfrutar de galletas, café y refresco.

A las 12:30 inició de nueva cuenta Mohamedalid Pacheco pero ahora con la plática titulada "Hacking Your Life".
Al terminar está plática se contó con una comida, donde se pudieron degustar sándwiches, café y refrescos.

A la 1:40 comenzó la última plática, la misma impartida por Luis Germán Ramírez titulada "Web3D: Sistemas de colaboración Educativa".
