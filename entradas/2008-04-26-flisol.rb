...
def publicacion(dir)
    ...
    p             = Publicacion.new
    p.directorio  = dir
    p.archivo     = '2008-04-26-flisol'
    p.nombre      = 'FLISOL 2008'
    p.nombre_menu = 'FLISOL 2008'
    p.fecha       = "2008-04-30 12:40"
...
* 10:00 *Introducción al Software Libre* por "J. Antonio Martínez Torres":http://www.antoniomtz.org/
* 11:00 *¿Qué se puede hacer con el Software Libre?* por "Guillermo Valdez Lozano":http://movimientolibre.com/
...
h3. Quiero ayudar ¿qué puedo hacer?
