...
def publicacion(dir)
    ...
    p             = Publicacion.new
    p.directorio  = dir
    p.archivo     = '2012-04-28-flisol'
    p.nombre      = 'FLISOL 2012'
    p.nombre_menu = 'FLISOL 2012'
    p.fecha       = "2012-04-28 00:01"
...
* 12:30 PM *Inovando con Software Libre* por Jesús Gómez (gomezbjesus)
* 2:00 PM a 6:00 PM *_Installfest_*: Instalación de software libre en las computadoras que lleven.
